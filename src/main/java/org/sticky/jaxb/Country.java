...
/**
 * A simple Country JAXB bean to use for producing comet code mappings dealing
 * with a Country object and encapsulate a code describing this country
 * 
...
public class Country implements Serializable {
	...
	final static public Country coding(Code code) {
